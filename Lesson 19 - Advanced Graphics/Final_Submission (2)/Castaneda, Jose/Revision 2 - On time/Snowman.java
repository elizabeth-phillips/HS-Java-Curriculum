...
public class Snowman extends JPanel {
    ...
    //Adds snow and speed of snow along with making everything else show up.
    ...
    //Helps redraw everything.
    @Override
    public void paint(Graphics g) {
        //Colors everything and makes the draws the actual object.
        setBackground(new Color(51, 153, 255));
        g.setColor(Color.WHITE);
        g.fillRect(0, 300, 600, 250);
        //Fills snowman and draws snowman
        drawSnowman(g, 150, 150);
        //Draws and fills in hat.
        drawHat(g, 175, 150);
        //Draws and fills in clouds.
    ...
    //Making snow appear in random places.
    ...
    //Gives size of the snowman and location.
    ...
    //Location of hat and size of different details.
    ...
    //Draws clouds in certain locations.
